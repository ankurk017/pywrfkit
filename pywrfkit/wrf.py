...
def add_coords(var: xr.DataArray, rename: bool = False) -> xr.DataArray:
    ...
    ----------
    var : xr.DataArray
        The input DataArray that contains 'XLONG' and 'XLAT' coordinates.
    rename : bool, optional
        If True, rename 'west_east' to 'longitudes' and 'south_north' 
...
def renamelatlon(var: xr.DataArray) -> xr.DataArray:
    ...
    ----------
    var : xr.DataArray
        The input DataArray with 'west_east' and 'south_north' coordinates.
